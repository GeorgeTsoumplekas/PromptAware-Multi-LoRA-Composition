...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Calculate DINO-based image alignment. "
    ...
    parser.add_argument(
        "--csv_filename",
        default="image_alignment_dino_results.csv",
...
def main():
    ...
    for folder in target_folders:
        ...
        print(
            ...
            f"average DINO similarity = {folder_avg:.4f}"
        )
    ...
    print(f"[RESULT] Overall average DINO similarity: {overall_average:.4f}")
